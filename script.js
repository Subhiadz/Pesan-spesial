$(document).ready(function () {
     ...
     */
    var content = [{
        title: "Hallo, Keysa Agnes Tasya",
        desc: "Kamu apa kabar? semoga kamu selalu ceria setiap hari, aku mau ngomong sesuatu nih, tekan tombol panah dibawah ini yaa!!!"
    }, {
        title: "Btw, kamu gak cape apa kelihatan cantik terus?",
        desc: "HEHEHE MAS GAKUAT, ARGG!!!"
    }, {
       title: "Sebenernya aku tuh pengen....",
       desc: "gimana ya ngomongnya, aku malu"
    }, {
        title: "PENGAN NGAJAK KAMU NGE DATE",
        desc: "KEMANA HAYO COBA TEBAK?"
    }, {
        title: "PANTAI DATE",
        desc: "aku pengen komunikasi ngobrol secara langsung tentang banyak hal, pasti bakalan asik banget deh sambil liat pemandangan indah laut dengerin ombak juga"
    }, {
        title: "JADI GIMANA???",
        desc: "MAU KANN, AKU TUNGGU JAWABANNYA!!! SEE U"
 }];
    var currentPage = 0;
    //generate content
